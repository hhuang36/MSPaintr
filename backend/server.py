...
mycursor.execute("CREATE DATABASE IF NOT EXISTS mspaintrdb")
...
'''testupdateq = "UPDATE Posts SET upvotes = %s WHERE postid = %s"
testupdata = (2, "eggie.png")
mycursor.execute(testupdateq, testupdata)
mydb.commit()
'''
